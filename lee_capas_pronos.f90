! _                                                                                __ ___   ___
!| | ___  ___     ___ __ _ _ __   __ _ ___      _ __  _ __ ___  _ __   ___  ___   / _/ _ \ / _ \
!| |/ _ \/ _ \   / __/ _` | '_ \ / _` / __|    | '_ \| '__/ _ \| '_ \ / _ \/ __| | || (_) | | | |
!| |  __/  __/  | (_| (_| | |_) | (_| \__ \    | |_) | | | (_) | | | | (_) \__ \_|  _\__, | |_| |
!|_|\___|\___|___\___\__,_| .__/ \__,_|___/____| .__/|_|  \___/|_| |_|\___/|___(_)_|   /_/ \___/
!           |_____|       |_|            |_____|_|
!
!    Programa para leer capas y hacer la integración en la vertical
!   
!    Jose Agustin Garcia Reynoso
!    Centro de Ciencias de la Atmosfera
!
!   ifort -O3 lee_capas_pronos.f90 -o lee_pronos.exe
!
      program lee_capas
      implicit none
      integer :: i,j,ii
...
!      parameter (nx= 20,ny=20,nxy=nx*ny,nvert=29,nf=4) ! Ecacor
      ...
      real,dimension(nxy) ::  dvar,lat,lon, pbl
